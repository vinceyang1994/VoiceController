...
public class AsrMain {
    ...
    private final String appKey = "Pa9S2khXihDvQeda4eohxeQ8";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    private final String secretKey = "ktbD2F7n20paeB8qgVzRVE6W0HAYtiL7";
 ...
 // 采样率固定值
    ...
    public String runJsonPostMethod(String token) throws DemoException, IOException {
        ...
        try {
            ...
            System.out.printf("JSON Format Error");
            e.printStackTrace();
        }
